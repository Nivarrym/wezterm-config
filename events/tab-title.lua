...
local GLYPH_SQUARE_LEFT = nf.fas_bracket_left --[[ [ ]]
local GLYPH_SQUARE_RIGHT = nf.fas_bracket_right --[[ ] ]]
...
-- stylua: ignore
local colors = {
   -- Tokyo Night / Omarchy-inspired palette
   text_default          = { bg = '#1a1b26', fg = '#565f89' },  -- dark bg, muted purple-gray text
   text_hover            = { bg = '#1a1b26', fg = '#7c7f93' },  -- slightly brighter on hover
   text_active           = { bg = '#7aa2f7', fg = '#1a1b26' },  -- blue accent with dark text

   unseen_output_default = { bg = '#1a1b26', fg = '#ff9e64' },  -- orange indicator
   unseen_output_hover   = { bg = '#1a1b26', fg = '#ff9e64' },
   unseen_output_active  = { bg = '#7aa2f7', fg = '#1a1b26' },  -- blend with active tab

   square_default       = { bg = 'rgba(0, 0, 0, 0.3)', fg = '#1a1b26' },
   square_hover         = { bg = 'rgba(0, 0, 0, 0.3)', fg = '#1a1b26' },
   square_active        = { bg = 'rgba(0, 0, 0, 0.3)', fg = '#7aa2f7' },
}
...
function Tab:create_cells()
   ...
   self.cells
      :add_segment('square_left', GLYPH_SQUARE_LEFT)
      ...
      :add_segment('padding', ' ')
      :add_segment('square_right', GLYPH_SQUARE_RIGHT)
end
...
function Tab:update_cells(event_opts, is_active, hover)
   ...
   self.cells
      :update_segment_colors('square_left', colors['square_' .. tab_state])
      ...
      :update_segment_colors('square_right', colors['square_' .. tab_state])
end
